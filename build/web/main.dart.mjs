...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1315: x0 => new WeakRef(x0),
      _1316: x0 => x0.deref(),
      _1323: () => globalThis.WeakRef,
      ...
      _1339: Object.is,
      _1340: o => o instanceof Array,
      _1341: (a, i) => a.push(i),
      _1345: a => a.pop(),
      _1346: (a, i) => a.splice(i, 1),
      _1347: (a, s) => a.join(s),
      _1348: (a, s, e) => a.slice(s, e),
      _1350: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1351: a => a.length,
      _1353: (a, i) => a[i],
      _1354: (a, i, v) => a[i] = v,
      _1356: o => {
      ...
      _1357: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1359: o => o instanceof Uint8Array,
      _1360: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1361: o => o instanceof Int8Array,
      _1362: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1363: o => o instanceof Uint8ClampedArray,
      _1364: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1365: o => o instanceof Uint16Array,
      _1366: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1367: o => o instanceof Int16Array,
      _1368: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1369: o => o instanceof Uint32Array,
      _1370: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1371: o => o instanceof Int32Array,
      _1372: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1374: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1375: o => o instanceof Float32Array,
      _1376: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1377: o => o instanceof Float64Array,
      _1378: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1379: (t, s) => t.set(s),
      _1380: l => new DataView(new ArrayBuffer(l)),
      ...
      _1425: () => Date.now(),
      _1430: o => Object.keys(o),
      _1431: (x0,x1) => new WebSocket(x0,x1),
      _1432: (x0,x1) => x0.send(x1),
      _1433: (x0,x1,x2) => x0.close(x1,x2),
      _1434: (x0,x1) => x0.close(x1),
      _1435: x0 => x0.close(),
      ...
      _3427: () => globalThis.window,
      _3470: x0 => x0.location,
      _3489: x0 => x0.navigator,
      _3753: x0 => x0.localStorage,
      _3761: x0 => x0.href,
      _3878: x0 => x0.userAgent,
      _3929: x0 => x0.data,
      _3976: (x0,x1) => { x0.onmessage = x1 },
      _4083: x0 => x0.length,
      _4300: x0 => x0.readyState,
      _4313: (x0,x1) => { x0.binaryType = x1 },
      _4316: x0 => x0.code,
      _4317: x0 => x0.reason,
      _6025: x0 => x0.signal,
      _7861: x0 => x0.value,
